...
public class Smoother {
    ...
    /**
     * Wraps a method to automatically {@link Wrapper#update() update()}
     * data from and {@link #push(double)} it into a {@link Smoother}.
     * @param n - the number of values to remember
    ...
    /**
     * Wraps a method to automatically {@link #update()} data from
     * and {@link #push(double)} it into a {@link Smoother}.
     */
    public static class Wrapper extends Smoother {
        ...
        /**
         * Add a value fetched from the getter (and delete the oldest if more than {@link Smoother#size size} values)
         */
        public void update() {
            push(getter.get());
        }
